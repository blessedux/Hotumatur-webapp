...
export default function RentalsHero() {
    ...
    const titleText = useDirectTranslation(
        "Experience the Magic of Rapa Nui with Us",
        "Vive la Magia de Rapa Nui con Nosotros"
    );

    const descriptionText = useDirectTranslation(
        "Discover Rapa Nui at your own pace with our rental options.",
        "Descubre Rapa Nui a tu propio ritmo con nuestras opciones de alquiler."
    );
    ...
    return (
        <div className="relative h-[calc(100dvh-80px)] md:h-[calc(100dvh-132px)] w-full overflow-hidden z-[1]">
            ...
            <div className="absolute top-0 left-0 w-full h-full z-[0]">
                <iframe
                    src="https://player.vimeo.com/video/1040049528?background=1&autoplay=1&loop=1&byline=0&title=0&muted=1"
                    className="absolute 
            ...
            <div className="relative z-10 flex h-full flex-col items-start justify-center px-4 text-white">
                {/* Title */}
                <h1 className="mb-4 text-left text-3xl md:text-5xl font-bold">
                    {titleText}
                </h1>
