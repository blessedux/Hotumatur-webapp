...
const TourSelector = () => {
        ...
        toast({
            ...
            description: (
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500">{`Código de reserva: ${reservationId}`}</p>
                    <Button
                        variant="outline"
                        size="sm"
    ...
    return (
        <div className="grid gap-4 md:grid-cols-[1fr_1.5fr_1fr_auto] items-end">
            ...
            <div className="space-y-2">
                <label className="text-lg">Personas:</label>
            ...
            <Button
                className="bg-white text-teal-800 hover:bg-white/90 self-end"
