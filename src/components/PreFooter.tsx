...
export default function BookingForm() {
    ...
    return (
        <div className="relative min-h-screen w-full bg-[url('/placeholder.svg?height=1080&width=1920')] bg-cover bg-center">
            <div className="absolute inset-0 bg-teal-800/80" />
            <div className="relative mx-auto max-w-4xl px-4 py-16 text-white">
